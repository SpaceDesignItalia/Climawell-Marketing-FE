...
import {
  EMAILCAMPAIGN_INITIAL,
  WHATSAPPCAMPAIGN_INITIAL,
...
export default function AddContactModel() {
  ...
  const [whatsappCampaign, setWhatsappCampaign] = useState<WhatsappCampaign>(
    WHATSAPPCAMPAIGN_INITIAL
  );
  ...
  const handleWhatsappCampaignInput = (
        ...
        setSelectedContacts([
          {
            ...
            name: res.data.StafferName + " " + res.data.StafferSurname,
          },
        ]);
      });
  }, []);
  ...
  async function handleSubmit() {
    try {
      ...
      if (campaignType === "whatsapp" || campaignType === "both") {
        if (
          whatsappCampaign.Title === "" ||
          whatsappCampaign.Description === "" ||
          images === null
        ) {
          alert("Compila tutti i campi");
          return;
        ...
        CustomerData.append(
          ...
          JSON.stringify(whatsappCampaign)
        );
      }

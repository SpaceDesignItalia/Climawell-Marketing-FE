...
export function CampaignRecipientSelector() {
  ...
  useEffect(() => {
    console.log("CampaignRecipientSelector - Tipo cliente aggiornato:", customerType);
  }, [customerType]);
  ...
  const handleCustomerTypeChange = (value: string) => {
    console.log("CampaignRecipientSelector - Cambio tipo cliente da", customerType, "a", value);
  ...
  const handleCapsSelect = (caps: Cap[]) => {
    console.log("CampaignRecipientSelector - Aggiornamento CAP selezionati:", caps.length);
    setSelectedCaps(caps);
  };
  
  // Handler per aggiornare gli agenti selezionati
  const handleContactsSelect = (contacts: Contact[]) => {
    console.log("CampaignRecipientSelector - Aggiornamento agenti selezionati:", contacts.length);
